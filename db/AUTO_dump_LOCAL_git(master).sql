...
-- Date: Mon, 13 Feb 2017 16:29:56 +0000
...
SET autocommit=0;
INSERT INTO `craft_matrixblocks` VALUES (10,2,26,1,1,NULL,'2017-02-10 16:12:46','2017-02-13 15:27:22','ac0d97b3-b0d0-4233-a805-defd59903454'),(11,2,26,1,2,NULL,'2017-02-10 16:12:46','2017-02-13 15:27:22','b87d020a-6602-4d25-bd3a-b0fcad65049f'),(18,2,46,5,1,NULL,'2017-02-12 16:23:11','2017-02-13 15:27:22','1ebf1595-1d0b-485a-9a47-0edb0cb88a8e'),(19,2,46,6,2,NULL,'2017-02-12 16:24:57','2017-02-13 15:27:22','db71a45b-2a1c-4df4-b1c9-9a975d7617ba'),(23,22,55,7,1,NULL,'2017-02-13 13:42:46','2017-02-13 13:42:46','f3410d10-3305-4c70-a81f-94149de87543'),(24,22,55,7,2,NULL,'2017-02-13 13:42:46','2017-02-13 13:42:46','210fa587-d82c-4af0-8a04-bdb73d9e325c'),(25,22,55,8,3,NULL,'2017-02-13 13:42:46','2017-02-13 13:42:46','3796f2d6-77f4-43dd-86e6-548d7dcbbba8');
...
SET autocommit=0;
INSERT INTO `craft_matrixblocktypes` VALUES (1,26,64,'Blokk','blokk',1,'2017-02-10 16:10:25','2017-02-11 01:17:41','a3a404a8-7cf6-4808-b23b-cdc5908893c4'),(5,46,109,'Enkel','enkel',1,'2017-02-12 16:19:20','2017-02-13 15:23:12','55995f5a-8564-4512-ab00-94b089f29429'),(6,46,111,'Menyer','menyer',2,'2017-02-12 16:21:45','2017-02-13 15:23:14','f7b50894-8f27-4761-83ec-a578abb60e12'),(7,55,93,'Enkel','enkel',1,'2017-02-13 12:27:29','2017-02-13 12:27:31','ca21f0e7-6e52-459a-870a-4c6e782cadb0'),(8,55,94,'Tekst og bilde','tekstOgBilde',2,'2017-02-13 12:27:31','2017-02-13 12:27:33','b7048c92-73ef-46dc-8045-e86a83c8ffb1');
...
--
-- Table structure for table `craft_matrixcontent_type`
--

/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `craft_matrixcontent_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `elementId` int(11) NOT NULL,
  `locale` char(12) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `uid` char(36) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `craft_matrixcontent_type_elementId_locale_unq_idx` (`elementId`,`locale`),
  KEY `craft_matrixcontent_type_locale_fk` (`locale`),
  CONSTRAINT `craft_matrixcontent_type_elementId_fk` FOREIGN KEY (`elementId`) REFERENCES `craft_elements` (`id`) ON DELETE CASCADE,
  CONSTRAINT `craft_matrixcontent_type_locale_fk` FOREIGN KEY (`locale`) REFERENCES `craft_locales` (`locale`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `craft_matrixcontent_type`
--

LOCK TABLES `craft_matrixcontent_type` WRITE;
/*!40000 ALTER TABLE `craft_matrixcontent_type` DISABLE KEYS */;
SET autocommit=0;
INSERT INTO `craft_matrixcontent_type` VALUES (1,23,'nb_no','Selskap','<p>Lorem ipsum dolor sit amet, bryllup adipiscing elit, sed do eiusmod dåp og minnestund incididunt ut labore et dolore magna aliqua. Juleord og juleselskap enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi.</p><p><strong><a href=\"{entry:4:url}\">Les mer</a></strong></p>','right',NULL,NULL,NULL,NULL,'2017-02-13 13:42:46','2017-02-13 13:42:46','f34dd366-ccec-4cff-9fc0-cb59d5979ac6'),(2,24,'nb_no','Historiske omgivelser','<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi.</p><p><strong><a href=\"{entry:5:url}\">Les mer</a></strong></p>','right',NULL,NULL,NULL,NULL,'2017-02-13 13:42:46','2017-02-13 13:42:46','8afe4e98-abe3-4500-a250-11531be0ade0'),(3,25,'nb_no',NULL,NULL,NULL,'Tester','<p>En test lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi.Les mer</p>','toKolonner','<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi. Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi.</p>','2017-02-13 13:42:46','2017-02-13 13:42:46','2de6a6ed-c024-450c-b2f7-287c5f37ed19');
/*!40000 ALTER TABLE `craft_matrixcontent_type` ENABLE KEYS */;
UNLOCK TABLES;
COMMIT;
...
SET autocommit=0;
INSERT INTO `craft_neoblocks` VALUES (22,2,54,1,0,NULL,'2017-02-13 13:42:46','2017-02-13 15:47:52','3f5a259c-cbec-408d-b3b4-e61f2c05d0a1');
...
SET autocommit=0;
INSERT INTO `craft_neoblockstructures` VALUES (4,4,2,54,NULL,'2017-02-13 15:27:22','2017-02-13 15:27:22','d26f92db-e5ee-4e40-bd4f-02fd67762af6');
...
SET autocommit=0;
INSERT INTO `craft_neoblocktypes` VALUES (1,54,96,'Designblokk','designblokk',NULL,NULL,'',1,1,'2017-02-13 12:14:43','2017-02-13 12:28:47','fe290cba-09d1-4eae-9ca8-b926fab43669');
...
SET autocommit=0;
INSERT INTO `craft_relabel` VALUES (8,23,98,'Ingress',NULL,'2017-02-13 13:36:21','2017-02-13 13:36:21','9c878e12-c037-4612-81b6-b714e97ddfa6');
...
SET autocommit=0;
INSERT INTO `craft_relations` VALUES (111,58,23,NULL,7,1,'2017-02-13 13:42:46','2017-02-13 13:42:46','0f8b634c-2300-408e-96e1-215fe355d418'),(112,58,24,NULL,6,1,'2017-02-13 13:42:46','2017-02-13 13:42:46','2d74c9c1-ea76-4b46-9cf4-8aec5f1c75bd'),(113,63,25,NULL,7,1,'2017-02-13 13:42:46','2017-02-13 13:42:46','47870919-0216-4d4f-abb0-b40d68e8d470'),(124,22,2,NULL,8,1,'2017-02-13 15:27:22','2017-02-13 15:27:22','2d6e3123-f1a1-48b2-9802-221f3b211989'),(125,28,10,NULL,15,1,'2017-02-13 15:27:22','2017-02-13 15:27:22','3a8efa5d-849a-4635-876d-825477ceddb9'),(126,28,11,NULL,16,1,'2017-02-13 15:27:22','2017-02-13 15:27:22','ec3d45d7-eef3-452e-ab12-b98464ea5cea'),(127,49,18,NULL,7,1,'2017-02-13 15:27:22','2017-02-13 15:27:22','bce2dd74-ecbc-401d-89d0-1d05ee9944c7'),(128,77,30,NULL,29,1,'2017-02-13 15:27:22','2017-02-13 15:27:22','8c40fbf1-45af-43dd-87e0-52216d8c6eff');
...
SET autocommit=0;
INSERT INTO `craft_structureelements` VALUES (7,4,NULL,7,1,4,0,'2017-02-13 15:27:22','2017-02-13 15:27:22','587650db-0022-4fac-a289-bf4d7d8614fb'),(8,4,22,7,2,3,1,'2017-02-13 15:27:22','2017-02-13 15:27:22','94fabdba-d086-496e-8476-23ca1d84e0ad');
...
-- Dump completed on: Mon, 13 Feb 2017 16:29:59 +0000
